...
def git_describe():
    try:
        git_info = subprocess.check_output(["git", "describe", "--always"]).strip().decode("utf-8")
        return git_info
    except:
        return None
...
def date_modified():
    try:
        file_path = r"C:\Users\lenovo\Desktop\project\L2CS-Net"  # Replace with the path to your file
